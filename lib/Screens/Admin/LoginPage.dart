...
import 'package:memorez/Screens/Admin/CreateAdmin.dart';
...
class _LoginFormState extends State<LoginForm> {
  ...
  Future<void> loadCredentials() async {
    String xmlBody =
    await rootBundle.loadString('assets/Twilio/Twilio_Credentials.xml');
    XmlDocument document = XmlDocument.parse(xmlBody);

    accountSid = document.getElement("credentials")!.getElement("accountSid")!.text;
    authToken = document.getElement("credentials")!.getElement("authToken")!.text;
    twilioNumber = document.getElement("credentials")!.getElement("twilioNumber")!.text;
  }
