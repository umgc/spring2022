                  ...
                  child: DragTarget<Task>(
                    builder: (
                      ...
                      return Container(
                          ...
                          child: Padding(
                              ...
                              child: Text(
                                  '$_taskOneComplete' +
                                      '$_taskOnePhrases', // Sets the drag target to the task 1 completed
                                  style: TextStyle(
                                      fontSize: 20.0,
                                      fontWeight: FontWeight.bold,
                                      color: Colors.lightBlue[900]))));
                    ...
                    onAccept: (Task data) {
                      ...
                      if (data.name == 'Brush your teeth') {
                        ...
                        taskPopUpMethod(
                            context, 'This space is reserved for task 1');
                      }
                    },
                  )),
                  ...
                  child: DragTarget<Task>(
                    builder: (
                      ...
                      return Container(
                          ...
                          child: Padding(
                              ...
                              child: Text(
                                  '$_taskTwoComplete' +
                                      '$_taskTwoPhrases', // Sets the drag target to the task 2 completed
                                  style: TextStyle(
                                      fontSize: 20.0,
                                      fontWeight: FontWeight.bold,
                                      color: Colors.lightBlue[900]))));
                    ...
                    onAccept: (Task data) {
                      ...
                      if (data.name == 'Go for a walk') {
                        ...
                        taskPopUpMethod(
                            context, 'This space is reserved for task 2');
                      }
                    },
                  )),
                  ...
                  child: DragTarget<Task>(
                    builder: (
                      ...
                      return Container(
                          ...
                          child: Padding(
                              ...
                              child: Text(
                                  '$_taskThreeComplete' +
                                      '$_taskThreePhrases', // Sets the drag target to the task 3 completed
                                  style: TextStyle(
                                      fontSize: 20.0,
                                      fontWeight: FontWeight.bold,
                                      color: Colors.lightBlue[900]))));
                    ...
                    onAccept: (Task data) {
                      ...
                      if (data.name == 'Drink your water') {
                        ...
                        taskPopUpMethod(
                            context, 'This space is reserved for task 3');
                      }
                    },
                  )),
