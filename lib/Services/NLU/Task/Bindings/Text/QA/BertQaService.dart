...
import 'TypesService.dart';
import '../../DynamicLibService.dart';
...
typedef _BertQuestionAnswererAnswer_native_t = Pointer<TfLiteQaAnswers>
    Function(Pointer<TfLiteBertQuestionAnswerer> questionAnswerer,
    Pointer<Utf8> context, Pointer<Utf8> question);
